...
//ListProperty destinatario
    ...
    public void loadData(File file) { //per avere dei msg iniziali
        emailList.setAll(
                new Email(0, "mittente0", "destinatario0", "argomento0", "testo0", "dataOggi"),
                new Email(1, "mittente1", "destinatario1", "argomento1", "testo1", "dataOggi"),
                new Email(2, "mittente2", "destinatario2", "argomento2", "testo2", "dataOggi"),
                new Email(0, "mittente0", "destinatario3", "argomento3", "testo3", "dataOggi"));
    }
}
